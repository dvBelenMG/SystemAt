    ...
    <div class="row justify-content-center">
        ...
        <div class="row justify-content-center">
            <div class=" dts col-sm-5 col-md-5 col-lg-5 bg-cont ">
              Nombre: brayan rosas colim  
            </div>
            <div class=" dts col-sm-5 col-md-5 col-lg-5 bg-cont ">
                Email: Bray4n@gmail.com
            </div>
        </div>
        <div class="row justify-content-center">
            <div class=" dts col-sm-5 col-md-5 col-lg-5 bg-cont ">
                Tutor de: israel monsalvo de jesus
            </div>
            <div class=" dts col-sm-5 col-md-5 col-lg-5 bg-cont ">
    ...
    <div class="container2">
        ...
        <div class="row mt-4 justify-content-center">
            ...
            <div class="col-sm-5 col-md-5 col-lg-5 border border-2 m-1 dts2">
                ...
                <p  class="text-poppins font-1">poder ayudar a mi hijo a comunicarse</p>
            ...
            <div class="col-sm-5 col-md-5 col-lg-5 border border-2  m-1 dts3">
               ...
               <p  class="text-poppins font-1">Quiero que mi hijo pueda comunicarse mas<br>Quiero que mi pueda socializar con mas personas</p>
        ...
        <div class="row mt-2 justify-content-center mb-5">
            ...
            <p  class="text-poppins font-1">Dificultad para que mi hijo pueda aprender a comunicarse frecuentemente</p>
