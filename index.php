...
<body>
    ...
    <div id="contenido">
        ...
        <div class="row mt-4">
          ...
          <img src="img/logAT.png" class="img-fluid mt-5" alt="...">
          </div>
          </div>
        </div>
        ...
        <div class="row mt-2">
          ...
          <CENTER><h1> ABILITYTALK</h1></CENTER>
          </div>
        </div>
        ...
        <div class="row mt-2 justify-content-center">
          ...
          <div class="col-sm-10 col-md-4 col-lg-4 mt-2 mb-4">
            
            <a href="registro.php">
                <div class="boton">
                <button class="btn-rl form-control">REGISTRARSE</button>
                </div>
            </a>
